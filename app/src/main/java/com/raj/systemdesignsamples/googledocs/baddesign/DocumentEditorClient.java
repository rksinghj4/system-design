package com.raj.systemdesignsamples.googledocs.baddesign;
...
//SRP is violating.
//OCP is violating.
//LSP is not applicable for Single class here. Can't say it is violating or not.
//ISP is not applicable for Single class here.
//DIP is not applicable for Single class here.
...
class DocumentEditor {
    ...
    //If any new feature comes in then we need to touch/modify the existing class
    // and rendering logic. There for it is bad design.
